...
public class TestStatistics {
	public static void main(String args[]){
		...
		sVals = Statistics.computeSortedData(data);
		min = Statistics.computeMin(data);
		max = Statistics.computeMax(data);
		mean = Statistics.computeMean(data);
		median = Statistics.computeMedian(sVals);
		...
		output = "The Total Number of Statistics objects created during execution: " + Statistics.count;
		JOptionPane.showMessageDialog(null,output);
		System.exit(0);
	}
}
